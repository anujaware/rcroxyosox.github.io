    ...
    function(
        ...
        var fakeServer = {
            ...
            fakeServerDecideWhichToShow: function(collection) {
                var collection = collection.where({
                    stub: false
                });
                ...
                if (lastItem.get('responseType') == ConversationItemModel.responseType.CHOICE) {
                    ...
                    if (typeof(nextId) != "undefined") {
                        var nextItem = _.findWhere(this.fakeDB, {
                            id: nextId
                        });
                        return nextItem;
                    } else {
                ...
                // If the last item was an INPUT value given
                    ...
                    var nextItem = _.findWhere(this.fakeDB, {
                        id: lastItem.get('possibleResponses')[0]
                    });
                    return nextItem;
                }
